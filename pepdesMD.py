"""This module is part of the  pepdesMD library,
written by Usuga Brandon.

The pepdesMD module contains code to generate 3D
structures of peptides. It requires the Geometry module
(also part of the pepdesMD library), which contains
